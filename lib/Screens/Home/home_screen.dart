...
import 'package:dash_app/Screens/Home/ui/header.dart';
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Wrap(
                  children: const [
                    ButtonsRow(text: 'Sort', leadingIcon: Icon(Icons.sort, size: 12), lastIcon: Icon(Icons.arrow_downward, size: 12),),
                    ButtonsRow(text: '2 - 7:00 PM tonight', leadingIcon: Icon(Icons.person_2_outlined, size: 12)),
                    ButtonsRow(text: 'Nearby', leadingIcon: Icon(Icons.location_city_outlined, size: 12)),
                    ButtonsRow(text: 'Over 4.5  |', leadingIcon: Icon(Icons.star_border, size: 12)),
                  ],
                ),
              ],
            ),
